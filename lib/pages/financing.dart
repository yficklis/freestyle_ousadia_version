...
class Financing extends StatefulWidget {
  ...
  Financing({Key key, this.is_partner, this.token}) : super(key: key);
...
class _FinancingState extends State<Financing> {
  ...
  String _buildJson() {
    ...
    String json =
        '{"type" : "$type","property_value" : "$property_value","desired_value" : "$desired_value","desired_period" : "$desired_period","contact_preferency" : "$contact_preferency","email" : "$email","name" : "$name","phone" : "$phone","celphone" : "$celphone"}';
    return json;
  }
